...
// Filter options - these would typically come from your backend
const filters = [
  {
    id: 'category',
    name: 'Category',
  ...
  },
  {
    ...
    options: [
      ...
      { value: '500-plus', label: '$500+', checked: false },
    ],
  },
]
...
export function FilterSortSystem() {
  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false)
  const [activeFilters, setActiveFilters] = useState([
    { id: 'category', value: 'smartphones', label: 'Smartphones' },
    { id: 'brand', value: 'apple', label: 'Apple' },
  ])

  const removeFilter = (filter: { id: string; value: string }) => {
    ...
    <div className="bg-white">
      ...
      <div className="border-b border-gray-200 pb-6">
        <div className="flex items-center justify-between">
          ...
          >
            <FunnelIcon className="mr-1 h-5 w-5 flex-shrink-0 text-gray-400" aria-hidden="true" />
            Filters
          </button>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {activeFilters.map((activeFilter) => (
              <button
                ...
                type="button"
                className="inline-flex items-center rounded-full border border-gray-200 bg-white py-1.5 pl-3 pr-2 text-sm font-medium text-gray-900"
              >
                <span>{activeFilter.label}</span>
                <XMarkIcon
                  className="ml-1 h-4 w-4 text-gray-400 hover:text-gray-500"
...
export default FilterSortSystem